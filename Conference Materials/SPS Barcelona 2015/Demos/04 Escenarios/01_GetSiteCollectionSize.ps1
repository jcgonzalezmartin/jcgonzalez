...
{ 
    ...
    {       
        ...
        {            
            ...
            Write-Host "Web App Url:" $spWebApp.DisplayName "| Site Collection:" $spSite.RootWeb.Title "| Site Collection Url:" $spSite.Url "| Site Usage:" $usage "MB" -ForegroundColor Green
        }  
    } 
    catch [System.Exception]
    {

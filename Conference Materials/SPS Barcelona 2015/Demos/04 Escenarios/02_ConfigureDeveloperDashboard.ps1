...
function Configure-DeveloperDashboard
{
    ...
    try
    {
        write-Host "Configuring the developer dashboard in mode $sDeveloperDashboardOption" -ForegroundColor Green
...
Configure-DeveloperDashboard -sDeveloperDashboardOption On
#Configure-DeveloperDashboard -sDeveloperDashboardOption Off

...
#Required Parameters
$sRESTUrl = "https://<O365Domain>.sharepoint.com/sites/<YourSiteCollection>/_api/web/lists" 
$sUserName = "<O365Domain>@nuberosnet.onmicrosoft.com" 
$sPassword = Read-Host -Prompt "Enter your password: " -AsSecureString  
$WebRMethod=[Microsoft.PowerShell.Commands.WebRequestMethod]::Get
$sCSOMPath="C:\Users\JuanCarlos\Desktop\89 SPS Barcelona\Demos\05 SPO\DLLs"

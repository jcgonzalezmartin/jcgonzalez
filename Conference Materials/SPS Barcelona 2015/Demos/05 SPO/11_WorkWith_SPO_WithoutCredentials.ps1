...
#Variables
$sClientId = "<ClientId>"
$sSecret = "<ClientSecret>";
$sRedirecturi = "https://<O365Domain>.sharepoint.com/sites/<SPOSiteCollection>/"
$sUrl = "https://<O365Domain>.sharepoint.com/sites/<SPOSiteCollection>/"
$sDomain = "itechcs.sharepoint.com"
#This identifier can be checked throught the Azure Portal

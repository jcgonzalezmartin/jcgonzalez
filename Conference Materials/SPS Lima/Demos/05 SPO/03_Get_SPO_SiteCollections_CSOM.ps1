...
function Get-SPOTenantSiteCollections
{
    ...
    {    
        ...
        Add-Type -Path "G:\03 Docs\10 MVP\04 Eventos\91 SPS Lima\Demos\05 SPO\DLLs\Microsoft.SharePoint.Client.dll"
        Add-Type -Path "G:\03 Docs\10 MVP\04 Eventos\91 SPS Lima\Demos\05 SPO\DLLs\Microsoft.SharePoint.Client.Runtime.dll"
        Add-Type -Path "G:\03 Docs\10 MVP\04 Eventos\91 SPS Lima\Demos\05 SPO\DLLs\Microsoft.Online.SharePoint.Client.Tenant.dll"
...
#Required Parameters
$sSiteUrl = "https://<SPO-Administration-Site>/" 
$sUserName = "<SPO_User>" 
